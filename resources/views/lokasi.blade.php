                                    ...
                                    <div class="col-lg-6 col-md-6 u-s-m-b-30">
                                        <div class="product-o product-o--radius product-o--hover-off u-h-100">
                                            <div class="product-o__wrap">
                                                ...
                                                <a class="aspect aspect--bg-grey aspect--square u-d-block" href="{{url('/lokasi'.'/'.$item->id)}}">
                                                ...
                                                <div class="product-o__action-wrap">
                                                    <ul class="product-o__action-list">
                                                        <li>
                                                            ...
                                                            <a href="{{url('/lokasi'.'/'.$item->id)}}" data-tooltip="tooltip" data-placement="top" title="Lihat Detail"><i class="fas fa-search-plus"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            <span class="product-o__category">
                                                ...
                                                <a href="shop-side-version-2.html">Lokasi</a></span>
        
                                            <span class="product-o__name">
        
                                                <a href="product-detail.html">{{$item->alamat}}</a></span>
                                                <div class="blog-t-w u-s-m-t-30">
                                                    <a href="{{$item->pin_lokasi}}" class="gl-tag btn--e-transparent-hover-brand-b-2">Lihat Maps</a>
                                                </div>
                                        </div>
                                    </div>
                                    @endforeach
